/// Material expander implemented using the hybrid_expander macro
///
/// This demonstrates how the macro can combine simple field reading
/// with custom logic for more complex dependency extraction.
use crate::hybrid_expander;

hybrid_expander! {
    MaterialExpanderMacro, b"MA\0\0", "Material" => {
        single_fields: ["nodetree"],
        array_fields: [],
        custom: |block_index, blend_file, dependencies| {
            // Custom logic for legacy material system - check for texture slots
