...
export function addOpenLink(menu: Menu, plugin: Plugin, video: HTMLVideoElement) {
    menu.addItem(item =>
        item
            .setIcon('lucide-file')
            .setTitle('Open link')
...
export function addOpenInNewTab(menu: Menu, plugin: Plugin, video: HTMLVideoElement) {
    menu.addItem(item =>
        item
...
export function addOpenToRight(menu: Menu, plugin: Plugin, video: HTMLVideoElement) {
    menu.addItem(item =>
        item
...
export function addOpenInNewWindow(menu: Menu, plugin: Plugin, video: HTMLVideoElement) {
    menu.addItem(item =>
        item
